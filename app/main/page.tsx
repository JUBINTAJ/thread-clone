...
//             <div key={post._id} className="flex border-[#3b3b3b] border">
//               <div className="p-2">
//                 <img className="w-10 ml-5 h-10 object-cover rounded-full" src={post.postById?.profilePic || "https://cdn-icons-png.flaticon.com/512/149/149071.png"} alt="Profile" />
//               </div>
//               <div className="flex-1 p-2">
//                 <div className="flex justify-between items-start">
...
//                 </div>
//                 <p className="pb-2">{post.text}</p>
//                 {post.image && <img className="h-[435px] rounded-md mb-4" src={post.image} alt="Post image" />}
//                 <div className="flex items-center gap-8">
//                   <Likebutton initialLike={post.likes.length} postId={post._id} likedUser={post.likes} />
//                   <div>
//                     <Image src={comment} alt="Comment" className="hover hover:bg-gray-900" />
//                   </div>
//                   <div>
//                     <Image src={repost} alt="Repost" className="hover hover:bg-gray-900 w-5" />
//                   </div>
//                   <div>
//                     <Image src={share} alt="Share" className="hover hover:bg-gray-900 w-5" />
//                   </div>
//                 </div>
//               </div>
//             </div>

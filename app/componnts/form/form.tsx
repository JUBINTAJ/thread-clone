...
<div className="relative w-full h-screen">
  ...
  <form onSubmit={handling}>
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex justify-center p-4 gap-3  relative">
        <a href="#" className="text-gray-500 hover:underline text-[11px] sm:text-[4px] md:text-[14px]">© 2024</a>
        <a href="#" className="text-gray-500 hover:underline text-[11px] sm:text-[4px] md:text-[14px]">Threads Terms</a>
        <a href="#" className="text-gray-500 hover:underline text-[11px] sm:text-[4px] md:text-[14px]">Privacy Policy</a>
        <a href="#" className="text-gray-500 hover:underline text-[11px] sm:text-[4px] md:text-[14px]">Cookies Policy</a>
        <a href="#" className="text-gray-500 hover:underline text-[11px] sm:text-[4px] md:text-[14px]">Report a problem</a>
        ...
        <div className="absolute bottom-4 right-4 p-4  ">
          ...
          {/* QR Image - hidden on small and medium screens */}
          <Image
            src={qr}
            alt="qr"

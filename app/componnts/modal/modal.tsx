...
export default function Modal({ isOpen, onClose }) {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-end justify-start   ml-6 mb-5">
        <div className="bg-[#5654543b] bg-opacity-50 text-white rounded-2xl p-6 w-64">
          ...
          <ul className="space-y-4">
            ...
            <li className="cursor-pointer hover:bg-gray-700 px-2 py-1 h-10 w-[225px] rounded-2xl text-red-500"  onClick={logout}>Log out</li>
          </ul>

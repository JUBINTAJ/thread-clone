...
<div>
 ...
 <div className='lay-5'>
  <div className='lay-6  border border-[#181818] border-[#3b3b3b]  w-[630px] h-[865px] border-b-0 mt-14   rounded-tl-[30px] rounded-tr-[30px] rounded-bl-none rounded-br-none scrollb '>
    {  posts.map((post)=>(
